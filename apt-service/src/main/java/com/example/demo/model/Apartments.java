...
public class Apartments {
	...
	public Apartments(long apartmentId, String apartmentTitle, String category, String unitNumber,
			String apartmentImages, String apartmentDescription, String apartmentPhoneNumber, String apartmentWebsite,
			String apartmentEmail, String apartmentCostDescription, double apartmentCost, String apartmentKeyword,
			String apartmentLocationCity, String apartmentLocationStreet, String apartmentLocationState,
			int apartmentLocationZipCode) {
		super();
	...
	public String toString() {
		return "Apartments [apartmentId=" + apartmentId + ", apartmentTitle=" + apartmentTitle + ", category="
				+ category + ", unitNumber=" + unitNumber + ", apartmentImages=" + apartmentImages
				+ ", apartmentDescription=" + apartmentDescription + ", apartmentPhoneNumber=" + apartmentPhoneNumber
				+ ", apartmentWebsite=" + apartmentWebsite + ", apartmentEmail=" + apartmentEmail
				+ ", apartmentCostDescription=" + apartmentCostDescription + ", apartmentCost=" + apartmentCost
				+ ", apartmentKeyword=" + apartmentKeyword + ", apartmentLocationCity=" + apartmentLocationCity
				+ ", apartmentLocationStreet=" + apartmentLocationStreet + ", apartmentLocationState="
				+ apartmentLocationState + ", apartmentLocationZipCode=" + apartmentLocationZipCode + "]";
	}
